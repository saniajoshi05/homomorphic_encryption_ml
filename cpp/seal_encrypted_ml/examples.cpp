...
int main()
{
    ...
    while (true)
    {
        ...
        cout << "| 9. Encrypted Linear Inference | 9_encrypted_linear_regression.cpp |" << endl;
        cout << "| 10. Encrypted Linear Model | 10_encrypted_linear_model.cpp |" << endl;
        cout << "+----------------------------+----------------------------+" << endl;
        ...
        */
        ...
        case 9:
            example_encrypted_linear_regression();
            break;

        case 10:
            example_encrypted_linear_model();
            break;
